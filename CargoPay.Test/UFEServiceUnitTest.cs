...
public class UFEServiceUnitTests
{
    ...
    private readonly Mock<IFeeHistoryRepository> _feeHistoryRepositoryMock;
    private readonly IUFEService _ufeService;

    public UFEServiceUnitTests()
    {
        _serviceProviderMock = new Mock<IServiceProvider>();
        _feeHistoryRepositoryMock = new Mock<IFeeHistoryRepository>();
        ...
        _serviceProviderMock.Setup(x => x.GetService(typeof(IFeeHistoryRepository))).Returns(_feeHistoryRepositoryMock.Object);
