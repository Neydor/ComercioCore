...
{
    private readonly Mock<IComercianteRepository> _cardRepositoryMock;
    private readonly Mock<IUsuarioRepository> _paymentRepositoryMock;
    private readonly Mock<IUFEService> _ufeServiceMock;
    private readonly Mock<IMemoryCache> _cacheMock;
    private readonly ComercianteService _cardService;
    private readonly ApplicationDbContext _dbContext;

    public CardServiceUnitTests()
    {
        _cardRepositoryMock = new Mock<IComercianteRepository>();
        _paymentRepositoryMock = new Mock<IUsuarioRepository>();
